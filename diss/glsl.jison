 ...
 * by the Khronos Group available at http://www.khronos.org/registry/gles/specs/2.0/
...
|[0-9]+('e'|'E')('+'|'-')?[0-9]+ return 'FLOATCONSTANT'; 
...
[1-9][0-9]*|'0'[0-7]+|'0'('x'|'X')[0-9a-fA-F]+|'0' return 'INTCONSTANT'; 
