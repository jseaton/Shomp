...
\begin{tikzpicture}[node distance=1cm, auto,]
 ...
 \node[punkt, right of=parser] (ui) {UI};
 \node[punkt, below of=parser] (param) {Parameter detection};
 \node[punkt] (opt) {Optimisations};
 \node[punkt] (annot) {Annotations};
\end{tikzpicture}
...
symbolic x coords={simple,gauss,chain,ham}]\addplot coordinates {(simple,22.2) (gauss,37.8) (chain,175.9) };
\addplot coordinates {(simple,10.9) (gauss,12.2) (chain,14.2) };
